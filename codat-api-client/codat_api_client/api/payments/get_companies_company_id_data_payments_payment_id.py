...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/data/payments/{paymentId}".format(
        client.base_url, companyId=company_id, paymentId=payment_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsPayment]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsPayment]:
    return Response(
