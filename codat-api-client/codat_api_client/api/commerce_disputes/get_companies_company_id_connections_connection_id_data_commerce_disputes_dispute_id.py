...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/data/commerce-disputes/{disputeId}".format(
        client.base_url, companyId=company_id, connectionId=connection_id, disputeId=dispute_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsCommerceDispute]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsCommerceDispute]:
    return Response(
