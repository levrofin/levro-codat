...
T = TypeVar("T", bound="CodatAssessDataContractsAccountCategoriesSuggestedAccountCategoryModel")
...
class CodatAssessDataContractsAccountCategoriesSuggestedAccountCategoryModel:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codat_assess_data_contracts_account_categories_suggested_account_category_model = cls(
            type=type,
            subtype=subtype,
        ...
        return codat_assess_data_contracts_account_categories_suggested_account_category_model
