...
T = TypeVar("T", bound="CodatDataContractsDatasetsBankTransactionsPushOperation")
...
class CodatDataContractsDatasetsBankTransactionsPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsBankTransactions]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsBankTransactions"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsBankTransactions.from_dict(_data)
        ...
        codat_data_contracts_datasets_bank_transactions_push_operation = cls(
        ...
        return codat_data_contracts_datasets_bank_transactions_push_operation
