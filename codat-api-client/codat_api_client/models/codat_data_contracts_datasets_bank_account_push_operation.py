...
T = TypeVar("T", bound="CodatDataContractsDatasetsBankAccountPushOperation")
...
class CodatDataContractsDatasetsBankAccountPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsBankAccount]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsBankAccount"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsBankAccount.from_dict(_data)
        ...
        codat_data_contracts_datasets_bank_account_push_operation = cls(
        ...
        return codat_data_contracts_datasets_bank_account_push_operation
