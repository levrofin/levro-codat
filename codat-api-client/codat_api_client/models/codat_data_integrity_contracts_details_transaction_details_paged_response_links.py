...
class CodatDataIntegrityContractsDetailsTransactionDetailsPagedResponseLinks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        codat_data_integrity_contracts_details_transaction_details_paged_response_links = cls()
        ...
        codat_data_integrity_contracts_details_transaction_details_paged_response_links.additional_properties = (
            additional_properties
        )
        return codat_data_integrity_contracts_details_transaction_details_paged_response_links
