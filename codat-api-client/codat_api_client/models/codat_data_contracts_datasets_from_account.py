...
T = TypeVar("T", bound="CodatDataContractsDatasetsFromAccount")
...
class CodatDataContractsDatasetsFromAccount:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codat_data_contracts_datasets_from_account = cls(
            account_ref=account_ref,
            currency=currency,
            amount=amount,
        )

        return codat_data_contracts_datasets_from_account
