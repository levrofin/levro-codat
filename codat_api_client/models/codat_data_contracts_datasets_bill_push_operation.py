...
T = TypeVar("T", bound="CodatDataContractsDatasetsBillPushOperation")
...
class CodatDataContractsDatasetsBillPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsBill]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsBill"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsBill.from_dict(_data)
        ...
        codat_data_contracts_datasets_bill_push_operation = cls(
        ...
        return codat_data_contracts_datasets_bill_push_operation
