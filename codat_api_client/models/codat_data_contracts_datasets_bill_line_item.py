...
if TYPE_CHECKING:
    ...
    from ..models.codat_data_contracts_datasets_accounts_payable_tracking import (
...
T = TypeVar("T", bound="CodatDataContractsDatasetsBillLineItem")
...
class CodatDataContractsDatasetsBillLineItem:
    ...
    Attributes:
        ...
        tracking (Union[Unset, CodatDataContractsDatasetsAccountsPayableTracking]):
        is_direct_cost (Union[Unset, bool]):
    """
    ...
    tracking: Union[Unset, "CodatDataContractsDatasetsAccountsPayableTracking"] = UNSET
    is_direct_cost: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if is_direct_cost is not UNSET:
            field_dict["isDirectCost"] = is_direct_cost
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_tracking, Unset):
            ...
            tracking = CodatDataContractsDatasetsAccountsPayableTracking.from_dict(_tracking)

        is_direct_cost = d.pop("isDirectCost", UNSET)

        codat_data_contracts_datasets_bill_line_item = cls(
        ...
        return codat_data_contracts_datasets_bill_line_item
