...
T = TypeVar("T", bound="CodatDataContractsDatasetsItemPushOperation")
...
class CodatDataContractsDatasetsItemPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsItem]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsItem"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsItem.from_dict(_data)
        ...
        codat_data_contracts_datasets_item_push_operation = cls(
        ...
        return codat_data_contracts_datasets_item_push_operation
