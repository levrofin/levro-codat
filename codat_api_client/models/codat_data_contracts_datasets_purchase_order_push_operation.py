...
T = TypeVar("T", bound="CodatDataContractsDatasetsPurchaseOrderPushOperation")
...
class CodatDataContractsDatasetsPurchaseOrderPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsPurchaseOrder]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsPurchaseOrder"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsPurchaseOrder.from_dict(_data)
        ...
        codat_data_contracts_datasets_purchase_order_push_operation = cls(
        ...
        return codat_data_contracts_datasets_purchase_order_push_operation
