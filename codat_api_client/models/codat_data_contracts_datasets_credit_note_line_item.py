...
if TYPE_CHECKING:
    ...
    from ..models.codat_data_contracts_datasets_accounts_receivable_tracking import (
...
T = TypeVar("T", bound="CodatDataContractsDatasetsCreditNoteLineItem")
...
class CodatDataContractsDatasetsCreditNoteLineItem:
    ...
    Attributes:
        ...
        tracking (Union[Unset, CodatDataContractsDatasetsAccountsReceivableTracking]):
        is_direct_income (Union[Unset, bool]):
    """
    ...
    tracking: Union[Unset, "CodatDataContractsDatasetsAccountsReceivableTracking"] = UNSET
    is_direct_income: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        is_direct_income = self.is_direct_income
        ...
        if is_direct_income is not UNSET:
            field_dict["isDirectIncome"] = is_direct_income
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_tracking, Unset):
            ...
            tracking = CodatDataContractsDatasetsAccountsReceivableTracking.from_dict(_tracking)

        is_direct_income = d.pop("isDirectIncome", UNSET)

        codat_data_contracts_datasets_credit_note_line_item = cls(
        ...
        return codat_data_contracts_datasets_credit_note_line_item
