...
if TYPE_CHECKING:
    ...
    from ..models.codat_data_contracts_datasets_invoiceable_tracking import (
...
T = TypeVar("T", bound="CodatDataContractsDatasetsDirectCostLineItem")
...
class CodatDataContractsDatasetsDirectCostLineItem:
    ...
    Attributes:
        ...
        tracking (Union[Unset, CodatDataContractsDatasetsInvoiceableTracking]):
    """
    ...
    tracking: Union[Unset, "CodatDataContractsDatasetsInvoiceableTracking"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_tracking, Unset):
            ...
            tracking = CodatDataContractsDatasetsInvoiceableTracking.from_dict(_tracking)

        codat_data_contracts_datasets_direct_cost_line_item = cls(
        ...
        return codat_data_contracts_datasets_direct_cost_line_item
