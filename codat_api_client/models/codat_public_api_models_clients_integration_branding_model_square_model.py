...
T = TypeVar("T", bound="CodatPublicApiModelsClientsIntegrationBrandingModelSquareModel")
...
class CodatPublicApiModelsClientsIntegrationBrandingModelSquareModel:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codat_public_api_models_clients_integration_branding_model_square_model = cls(
            image=image,
        )

        return codat_public_api_models_clients_integration_branding_model_square_model
