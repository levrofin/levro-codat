...
T = TypeVar("T", bound="CodatDataContractsDatasetsBillPaymentPushOperation")
...
class CodatDataContractsDatasetsBillPaymentPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsBillPayment]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsBillPayment"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsBillPayment.from_dict(_data)
        ...
        codat_data_contracts_datasets_bill_payment_push_operation = cls(
        ...
        return codat_data_contracts_datasets_bill_payment_push_operation
