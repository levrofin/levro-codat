...
T = TypeVar("T", bound="CodatDataContractsDatasetsSupplierPushOperation")
...
class CodatDataContractsDatasetsSupplierPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsSupplier]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsSupplier"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsSupplier.from_dict(_data)
        ...
        codat_data_contracts_datasets_supplier_push_operation = cls(
        ...
        return codat_data_contracts_datasets_supplier_push_operation
