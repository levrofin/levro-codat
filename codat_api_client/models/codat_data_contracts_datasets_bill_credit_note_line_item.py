...
T = TypeVar("T", bound="CodatDataContractsDatasetsBillCreditNoteLineItem")
...
class CodatDataContractsDatasetsBillCreditNoteLineItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codat_data_contracts_datasets_bill_credit_note_line_item = cls(
        ...
        return codat_data_contracts_datasets_bill_credit_note_line_item
