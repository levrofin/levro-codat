...
T = TypeVar("T", bound="CodatDataContractsDatasetsBillCreditNotePushOperation")
...
class CodatDataContractsDatasetsBillCreditNotePushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsBillCreditNote]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsBillCreditNote"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsBillCreditNote.from_dict(_data)
        ...
        codat_data_contracts_datasets_bill_credit_note_push_operation = cls(
        ...
        return codat_data_contracts_datasets_bill_credit_note_push_operation
