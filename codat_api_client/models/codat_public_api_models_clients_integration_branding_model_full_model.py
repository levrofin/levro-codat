...
T = TypeVar("T", bound="CodatPublicApiModelsClientsIntegrationBrandingModelFullModel")
...
class CodatPublicApiModelsClientsIntegrationBrandingModelFullModel:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codat_public_api_models_clients_integration_branding_model_full_model = cls(
            image=image,
        )

        return codat_public_api_models_clients_integration_branding_model_full_model
