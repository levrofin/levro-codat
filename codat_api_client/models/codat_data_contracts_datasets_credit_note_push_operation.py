...
T = TypeVar("T", bound="CodatDataContractsDatasetsCreditNotePushOperation")
...
class CodatDataContractsDatasetsCreditNotePushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsCreditNote]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsCreditNote"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsCreditNote.from_dict(_data)
        ...
        codat_data_contracts_datasets_credit_note_push_operation = cls(
        ...
        return codat_data_contracts_datasets_credit_note_push_operation
