...
T = TypeVar("T", bound="CodatDataContractsDatasetsJournalEntryPushOperation")
...
class CodatDataContractsDatasetsJournalEntryPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsJournalEntry]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsJournalEntry"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsJournalEntry.from_dict(_data)
        ...
        codat_data_contracts_datasets_journal_entry_push_operation = cls(
        ...
        return codat_data_contracts_datasets_journal_entry_push_operation
