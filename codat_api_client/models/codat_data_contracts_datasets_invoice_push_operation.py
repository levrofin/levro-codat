...
T = TypeVar("T", bound="CodatDataContractsDatasetsInvoicePushOperation")
...
class CodatDataContractsDatasetsInvoicePushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsInvoice]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsInvoice"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsInvoice.from_dict(_data)
        ...
        codat_data_contracts_datasets_invoice_push_operation = cls(
        ...
        return codat_data_contracts_datasets_invoice_push_operation
