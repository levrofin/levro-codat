...
T = TypeVar("T", bound="CodatDataContractsDatasetsDirectIncomePushOperation")
...
class CodatDataContractsDatasetsDirectIncomePushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsDirectIncome]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsDirectIncome"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsDirectIncome.from_dict(_data)
        ...
        codat_data_contracts_datasets_direct_income_push_operation = cls(
        ...
        return codat_data_contracts_datasets_direct_income_push_operation
