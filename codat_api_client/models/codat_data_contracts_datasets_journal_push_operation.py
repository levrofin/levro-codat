...
T = TypeVar("T", bound="CodatDataContractsDatasetsJournalPushOperation")
...
class CodatDataContractsDatasetsJournalPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsJournal]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsJournal"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsJournal.from_dict(_data)
        ...
        codat_data_contracts_datasets_journal_push_operation = cls(
        ...
        return codat_data_contracts_datasets_journal_push_operation
