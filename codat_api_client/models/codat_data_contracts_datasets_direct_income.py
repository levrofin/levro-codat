...
if TYPE_CHECKING:
    ...
    from ..models.codat_data_contracts_datasets_direct_income_line_item import (
...
T = TypeVar("T", bound="CodatDataContractsDatasetsDirectIncome")
...
class CodatDataContractsDatasetsDirectIncome:
    ...
    Attributes:
        ...
        currency (str):
        line_items (List['CodatDataContractsDatasetsDirectIncomeLineItem']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for line_items_item_data in _line_items:
            line_items_item = CodatDataContractsDatasetsDirectIncomeLineItem.from_dict(line_items_item_data)
        ...
        codat_data_contracts_datasets_direct_income = cls(
        ...
        return codat_data_contracts_datasets_direct_income
