...
T = TypeVar("T", bound="CodatDataContractsPushPushOptionProperties")


@define
class CodatDataContractsPushPushOptionProperties:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        codat_data_contracts_push_push_option_properties = cls()
        ...
        codat_data_contracts_push_push_option_properties.additional_properties = additional_properties
        return codat_data_contracts_push_push_option_properties
