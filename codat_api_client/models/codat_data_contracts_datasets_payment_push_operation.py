...
T = TypeVar("T", bound="CodatDataContractsDatasetsPaymentPushOperation")
...
class CodatDataContractsDatasetsPaymentPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsPayment]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsPayment"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsPayment.from_dict(_data)
        ...
        codat_data_contracts_datasets_payment_push_operation = cls(
        ...
        return codat_data_contracts_datasets_payment_push_operation
