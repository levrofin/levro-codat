...
T = TypeVar("T", bound="CodatDataContractsDatasetsAccountPushOperation")
...
class CodatDataContractsDatasetsAccountPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsAccount]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsAccount"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsAccount.from_dict(_data)
        ...
        codat_data_contracts_datasets_account_push_operation = cls(
        ...
        return codat_data_contracts_datasets_account_push_operation
