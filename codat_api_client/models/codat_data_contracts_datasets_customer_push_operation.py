...
T = TypeVar("T", bound="CodatDataContractsDatasetsCustomerPushOperation")
...
class CodatDataContractsDatasetsCustomerPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsCustomer]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsCustomer"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsCustomer.from_dict(_data)
        ...
        codat_data_contracts_datasets_customer_push_operation = cls(
        ...
        return codat_data_contracts_datasets_customer_push_operation
