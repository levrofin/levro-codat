...
T = TypeVar("T", bound="CodatDataContractsDatasetsTransferPushOperation")
...
class CodatDataContractsDatasetsTransferPushOperation:
    ...
    Attributes:
        ...
        data (Union[Unset, CodatDataContractsDatasetsTransfer]):
    ...
    data: Union[Unset, "CodatDataContractsDatasetsTransfer"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = CodatDataContractsDatasetsTransfer.from_dict(_data)
        ...
        codat_data_contracts_datasets_transfer_push_operation = cls(
        ...
        return codat_data_contracts_datasets_transfer_push_operation
