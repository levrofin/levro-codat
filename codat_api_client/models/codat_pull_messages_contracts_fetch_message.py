...
T = TypeVar("T", bound="CodatPullMessagesContractsFetchMessage")
...
class CodatPullMessagesContractsFetchMessage:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        codat_pull_messages_contracts_fetch_message = cls(
            log_level=log_level,
            message=message,
            log_date_time_utc=log_date_time_utc,
        )

        return codat_pull_messages_contracts_fetch_message
