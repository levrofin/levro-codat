...
if TYPE_CHECKING:
    from ..models.codat_data_contracts_datasets_bill_payment_line_link import (
        CodatDataContractsDatasetsBillPaymentLineLink,
    )


T = TypeVar("T", bound="CodatDataContractsDatasetsBillPaymentLine")
...
class CodatDataContractsDatasetsBillPaymentLine:
    ...
    Attributes:
        amount (float):
        links (Union[Unset, None, List['CodatDataContractsDatasetsBillPaymentLineLink']]):
        allocated_on_date (Union[Unset, None, datetime.datetime]):
    """

    amount: float
    links: Union[Unset, None, List["CodatDataContractsDatasetsBillPaymentLineLink"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for links_item_data in _links or []:
            links_item = CodatDataContractsDatasetsBillPaymentLineLink.from_dict(links_item_data)
        ...
        codat_data_contracts_datasets_bill_payment_line = cls(
            amount=amount,
            links=links,
            allocated_on_date=allocated_on_date,
        )

        return codat_data_contracts_datasets_bill_payment_line
