...
if TYPE_CHECKING:
    ...
    from ..models.codat_assess_data_contracts_loans_loan_item import CodatAssessDataContractsLoansLoanItem


T = TypeVar("T", bound="CodatAssessDataContractsLoansLoanTransactionsReport")


@define
class CodatAssessDataContractsLoansLoanTransactionsReport:
    """
    Attributes:
        report_info (Union[Unset, CodatAssessDataContractsCommonPagedReportInfo]):
        report_items (Union[Unset, None, List['CodatAssessDataContractsLoansLoanItem']]):
    """

    report_info: Union[Unset, "CodatAssessDataContractsCommonPagedReportInfo"] = UNSET
    report_items: Union[Unset, None, List["CodatAssessDataContractsLoansLoanItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for report_items_item_data in _report_items or []:
            report_items_item = CodatAssessDataContractsLoansLoanItem.from_dict(report_items_item_data)

            report_items.append(report_items_item)

        codat_assess_data_contracts_loans_loan_transactions_report = cls(
            report_info=report_info,
            report_items=report_items,
        )

        return codat_assess_data_contracts_loans_loan_transactions_report
