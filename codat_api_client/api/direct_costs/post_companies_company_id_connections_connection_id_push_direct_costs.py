...
from ...models.codat_data_contracts_datasets_direct_cost_push_operation import (
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: CodatDataContractsDatasetsDirectCost,
    timeout_in_minutes: Union[Unset, None, int] = UNSET,
) -> Dict[str, Any]:
    url = "{}/companies/{companyId}/connections/{connectionId}/push/directCosts".format(
...
) -> Optional[CodatDataContractsDatasetsDirectCostPushOperation]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CodatDataContractsDatasetsDirectCostPushOperation.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[CodatDataContractsDatasetsDirectCostPushOperation]:
    return Response(
