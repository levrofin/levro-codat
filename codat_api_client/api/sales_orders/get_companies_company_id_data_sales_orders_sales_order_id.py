...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/data/salesOrders/{salesOrderId}".format(
        client.base_url, companyId=company_id, salesOrderId=sales_order_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsSalesOrder]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsSalesOrder]:
    return Response(
