...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/push/purchaseOrders/{purchaseOrderId}".format(
        client.base_url, companyId=company_id, connectionId=connection_id, purchaseOrderId=purchase_order_id
    )
