...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/data/customers/{customerId}".format(
        client.base_url, companyId=company_id, customerId=customer_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsCustomer]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsCustomer]:
    return Response(
