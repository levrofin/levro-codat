...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/data/companies/{companyId}/connections/{connectionId}/assess/commerceMetrics/revenue".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Gets the revenue and revenue growth for a specific company connection, over one or more periods of
    time.
