...
def _get_kwargs(
    ...
    *,
    ...
    show_input_values: Union[Unset, None, bool] = False,
) -> Dict[str, Any]:
    url = "{}/data/companies/{companyId}/connections/{connectionId}/assess/accountingMetrics/marketing".format(
    ...
    params["showInputValues"] = show_input_values
...
def sync_detailed(
    ...
    *,
    ...
    """Gets the marketing metrics from an accounting source for a given company, over one or more periods
    of time.
    ...
    Args:
        ...
        show_input_values (Union[Unset, None, bool]):
