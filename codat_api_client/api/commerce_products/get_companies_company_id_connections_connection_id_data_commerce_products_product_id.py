...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/data/commerce-products/{productId}".format(
        client.base_url, companyId=company_id, connectionId=connection_id, productId=product_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsCommerceProduct]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsCommerceProduct]:
    return Response(
