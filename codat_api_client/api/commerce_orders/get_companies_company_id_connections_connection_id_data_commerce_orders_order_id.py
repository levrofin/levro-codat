...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/data/commerce-orders/{orderId}".format(
        client.base_url, companyId=company_id, connectionId=connection_id, orderId=order_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsCommerceOrder]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsCommerceOrder]:
    return Response(
