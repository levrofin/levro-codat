...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/data/transfers/{transferId}".format(
        client.base_url, companyId=company_id, connectionId=connection_id, transferId=transfer_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsTransfer]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsTransfer]:
    return Response(
