...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/data/directIncomes/{directIncomeId}".format(
        client.base_url, companyId=company_id, connectionId=connection_id, directIncomeId=direct_income_id
    )
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CodatDataContractsDatasetsDirectIncome]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CodatDataContractsDatasetsDirectIncome]:
    return Response(
