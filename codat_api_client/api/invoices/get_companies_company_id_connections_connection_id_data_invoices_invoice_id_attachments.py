...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/companies/{companyId}/connections/{connectionId}/data/invoices/{invoiceId}/attachments".format(
        client.base_url, companyId=company_id, connectionId=connection_id, invoiceId=invoice_id
    )
